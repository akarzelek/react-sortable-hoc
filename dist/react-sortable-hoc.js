...
function setTranslate3d(translate) {
...
function getLockPixelOffset(_ref3) {
  var lockOffset = _ref3.lockOffset,
    width = _ref3.width,
    height = _ref3.height;
...
function getLockPixelOffsets(_ref4) {
  var height = _ref4.height,
    width = _ref4.width,
    lockOffset = _ref4.lockOffset;
        ...
        _defineProperty(
          ...
          function() {
            ...
            if (isKeySorting) {
              ...
              setInlineStyles(_this.helper, setTranslate3d(_this.translate));
          ...
          value: function animateNodes() {
            ...
            for (var _i = 0, _len = nodes.length; _i < _len; _i++) {
              ...
              if (transitionDuration) {
                nodesTransitionStyle[_i] = _objectSpread(
                  {},
                  nodesTransitionStyle[_i],
                  setTransitionDuration(transitionDuration),
                );
              }

              setInlineStyles(nodes[_i].node, nodesTransitionStyle[_i]);
            }
